...
from fast_adv.models.cifar10 import wide_resnet, resnet18
...
parser.add_argument('--data', default='C:/Users/WenqingLiu/cifar/cifar10/cifar-10-batches-py/', help='path to dataset')
parser.add_argument('--workers', default=0, type=int, help='number of data loading workers')
parser.add_argument('--cpu', action='store_true', help='force training on cpu')
parser.add_argument('--save-folder', '--sf', default='D:/python_workplace/resnet-AE/model/DDN_adv/', help='folder to save state dicts')
...
parser.add_argument('--epochs', '-e', default=230, type=int, help='number of total epochs to run')
...
parser.add_argument('--adv', default=200, type=int, help='epoch to start training with adversarial images')
...
DEVICE = torch.device('cuda:1' if (torch.cuda.is_available() and not args.cpu) else 'cpu')
