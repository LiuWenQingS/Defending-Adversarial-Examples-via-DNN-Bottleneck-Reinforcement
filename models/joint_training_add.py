...
class joint_model_1(nn.Module):
    ...
    def forward(self, x):
        ...
        ae_block_1 = self.encoder_layer1(x)

        # classification part
        out_1 = self.layer2(ae_block_1)
        ...
        # auto encoder part
        ae_block_2 = self.encoder_layer2(ae_block_1)
        ae_block_3 = self.encoder_layer3(ae_block_2)
        ae_block_4 = self.encoder_layer4(ae_block_3)
        out_2 = self.decoder_layer1(ae_block_4) + ae_block_4
        out_2 = self.decoder_layer2(out_2) + ae_block_3
        out_2 = self.decoder_layer3(out_2) + ae_block_2
        out_2 = self.decoder_layer4(out_2) + ae_block_1
