...
class joint_model_1(nn.Module):
    ...
    def forward(self, x):
        ...
        de_block_1 = self.decoder_layer1(en_block_4) + en_block_4
        de_block_2 = self.decoder_layer2(de_block_1) + en_block_3
        de_block_3 = self.decoder_layer3(de_block_2) + en_block_2
        de_block_4 = self.decoder_layer4(de_block_3) + en_block_1
