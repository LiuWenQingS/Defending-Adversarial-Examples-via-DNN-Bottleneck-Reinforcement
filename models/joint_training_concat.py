...
class joint_model_1(nn.Module):
    ...
    def forward(self, x):
        ...
        out_2 = torch.cat((self.decoder_layer1(ae_block_4), ae_block_4), 1)
        # print(ae_block_4.shape)
        # print(out_2.shape)
        out_2 = torch.cat((self.decoder_layer2(out_2), ae_block_3), 1)
        out_2 = torch.cat((self.decoder_layer3(out_2), ae_block_2), 1)
        out_2 = torch.cat((self.decoder_layer4(out_2), ae_block_1), 1)
