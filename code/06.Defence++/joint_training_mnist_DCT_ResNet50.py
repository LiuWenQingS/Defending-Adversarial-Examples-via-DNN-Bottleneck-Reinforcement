...
from models.joint_training_AddLoss import joint_model_1, joint_model_2, joint_model_3, joint_model_4, Bottleneck_encoder, BasicBlock_decoder
...
def joint_train(best_cla_model_path, block, device_used):
    ...
    parser.add_argument("--input_dir_trainSet", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Joint_Training_DCT_0.01(14,7)/ResNet50/mnist/train/train.pkl",
                        help="data set dir path")
    parser.add_argument("--input_dir_testSet", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Joint_Training_DCT_0.01(14,7)/ResNet50/mnist/test/test.pkl",
                        help="data set dir path")
    parser.add_argument("--model_path", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Joint_Training_DCT_0.01(14,7)/ResNet50/mnist/block_"
                                + str(block) + "/model/",
    ...
    model_1 = joint_model_1(Bottleneck_encoder, BasicBlock_decoder, [3, 4, 6, 3])
    model_2 = joint_model_2(Bottleneck_encoder, BasicBlock_decoder, [3, 4, 6, 3])
    model_3 = joint_model_3(Bottleneck_encoder, BasicBlock_decoder, [3, 4, 6, 3])
    model_4 = joint_model_4(Bottleneck_encoder, BasicBlock_decoder, [3, 4, 6, 3])
    ...
    # print(len(pretrained_weight_key))
...
if __name__ == "__main__":
    best_cla_model_path = "D:/python_workplace/resnet-AE/checkpoint/Classification/ResNet50/mnist/model/model_" \
                          + str(165) + ".pth"
    for i in range(1):
        joint_train(best_cla_model_path, 4, "cuda:1")
