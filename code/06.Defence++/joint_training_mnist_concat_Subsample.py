...
from models.joint_training_concat_AddLoss import joint_model_1, joint_model_2, joint_model_3, joint_model_4, BasicBlock_encoder, BasicBlock_decoder
...
def joint_train(best_cla_model_path, block, device_used):
    ...
    parser.add_argument("--input_dir_trainSet", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Joint_Training_Concat_Subsample/ResNet18/mnist/train/train.pkl",
                        help="data set dir path")
    parser.add_argument("--input_dir_testSet", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Joint_Training_Concat_Subsample/ResNet18/mnist/test/test.pkl",
                        help="data set dir path")
    parser.add_argument("--model_path", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Joint_Training_Concat_Subsample/ResNet18/mnist/block_"
                                + str(block) + "/model/",
                ...
                with open(args.loss_file_path, "w") as f4:
                    for epoch in range(1, args.epochs + 1):
                        ...
                        for i, data in enumerate(train_loader, 0):
                            ...
                            # forward + backward
                            outputs_cla, de_block_1, de_block_2, de_block_3, de_block_4, outputs_ae = model(inputs)
                            ...
                            loss = loss_cla + 0.8 * loss_ae + 0.5 * (loss_block_1 + loss_block_2 + loss_block_3 + loss_block_4)
                            loss.backward()
                            optimizer.step()
...
if __name__ == "__main__":
    best_cla_model_path = "D:/python_workplace/resnet-AE/checkpoint/Classification/ResNet18/mnist/model/model_" \
                          + str(139) + ".pth"
    for i in range(4):
        joint_train(best_cla_model_path, i + 1, "cuda:0")
