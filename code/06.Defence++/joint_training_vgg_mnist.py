...
def joint_train(best_cla_model_path, best_ae_model_path, device_used):
    ...
    parser.add_argument("--input_path", type=str, default="C:/Users/WenqingLiu/mnist/",
    ...
    parser.add_argument("--input_dir_trainSet", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Joint_Training/VGG/mnist/data/train/train.pkl",
                        help="data set dir path")
    parser.add_argument("--input_dir_testSet", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Joint_Training/VGG/mnist/data/test/test.pkl",
                        help="data set dir path")
    parser.add_argument("--model_path", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Joint_Training/VGG/mnist/model/",
                        help="Save model path")
    parser.add_argument("--image_path", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Joint_Training/VGG/mnist/image/",
                        help="Save log file")
    parser.add_argument("--acc_file_path", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Joint_Training/VGG/mnist/acc.txt",
                        help="Save accuracy file")
    parser.add_argument("--best_acc_file_path", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Joint_Training/VGG/mnist/best_acc.txt",
                        help="Save best accuracy file")
    parser.add_argument("--log_cla_file_path", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Joint_Training/VGG/mnist/log_cla.txt",
                        help="Save log file")
    parser.add_argument("--log_ae_file_path", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Joint_Training/VGG/mnist/log_ae.txt",
                        help="Save log file")
    parser.add_argument("--loss_file_path", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Joint_Training/VGG/mnist/loss.txt",
                        help="Save log file")
    parser.add_argument("--min_loss_file_path", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Joint_Training/VGG/mnist/min_loss.txt",
                        help="Save log file")
    ...
    #     if i < len(pretrained_cla_weight_key):
    #         new_dict[model_weight_key[i]] = pretrained_cla_weight_value[i]
    #     else:
    #         new_dict[model_weight_key[i]] = pretrained_ae_weight_value[i - len(pretrained_cla_weight_key) + 14]
    #
                        ...
                        if epoch % 20 == 0:
                            ...
                            with torch.no_grad():
                                ...
                                for batchSize, images_clean, images_adv, labels in load_images(args.input_dir_testSet,
                                    ...
                                    # print(images_clean.cpu().data.numpy().shape)
...
if __name__ == "__main__":
    best_cla_model_path = "D:/python_workplace/resnet-AE/checkpoint/Classification/VGG/mnist/model/model_" \
                          + str(150) + ".pth"
    best_ae_model_path = "D:/python_workplace/resnet-AE/checkpoint/Autoencoder/VGG/mnist/model/model_" \
                         + str(30) + ".pth"
