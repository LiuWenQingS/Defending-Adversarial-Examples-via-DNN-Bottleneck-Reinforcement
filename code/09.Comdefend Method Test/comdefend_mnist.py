...
def train_ae(device_used):
    ...
    parser.add_argument("--model_path", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Autoencoder/mnist/comdefend/model/",
                        help="Save model path")
    parser.add_argument("--min_loss_path", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Autoencoder/mnist/comdefend/min_loss.txt",
                        help="Save min loss")
    parser.add_argument("--image_compare", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Autoencoder/mnist/comdefend/images/",
                        help="Save images")
    parser.add_argument("--log_file_path", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Autoencoder/mnist/comdefend/log.txt",
                        help="Save log file")
    parser.add_argument("--loss_file_path", type=str,
                        default="D:/python_workplace/resnet-AE/checkpoint/Autoencoder/mnist/comdefend/loss.txt",
                        help="Save loss file")
            ...
            for epoch in range(1, args.epochs + 1):
                ...
                for i, data in enumerate(train_loader, 0):
                    ...
                    print("[Epoch:%d/%d] | [Batch:%d/%d] | Loss: %.03f | Lr: %.04f | Time: %.03fs"
                          % (
                          epoch, args.epochs, batch_id, (60000 / args.batch_size) + 1, sum_loss / batch_id, args.lr,
                          (end - start)))
                    f1.write("[Epoch:%d/%d] | [Batch:%d/%d] | Loss: %.03f | Lr: %.4f | Time: %.3fs"
                             % (epoch, args.epochs, batch_id, (60000 / args.batch_size) + 1, sum_loss / batch_id,
                                args.lr, (end - start)))
                    f1.write("\n")
                    f1.flush()
                    batch_id += 1
