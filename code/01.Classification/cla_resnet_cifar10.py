...
parser.add_argument("--model_path", type=str,
                    default="D:/python_workplace/resnet-AE/checkpoint/Classification/ResNet50/cifar10/model/",
                    help="Save model path")
parser.add_argument("--acc_file_path", type=str,
                    default="D:/python_workplace/resnet-AE/checkpoint/Classification/ResNet50/cifar10/acc.txt",
                    help="Save accuracy file")
parser.add_argument("--best_acc_file_path", type=str,
                    default="D:/python_workplace/resnet-AE/checkpoint/Classification/ResNet50/cifar10/best_acc.txt",
                    help="Save best accuracy file")
parser.add_argument("--log_file_path", type=str,
                    default="D:/python_workplace/resnet-AE/checkpoint/Classification/ResNet50/cifar10/log.txt",
                    help="Save log file")
...
if __name__ == "__main__":
    # path = "D:/python_workplace/resnet-AE/checkpoint/Classification/ResNet50/cifar10/model/model_300_1.pth"
    train_cla()
