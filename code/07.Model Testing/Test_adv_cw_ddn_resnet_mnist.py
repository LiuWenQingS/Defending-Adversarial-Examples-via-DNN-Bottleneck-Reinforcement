...
def load_images(input_dir, batch_shape_clean, batch_shape_adv):
    ...
    for i in range(len(labels_list)):
        ...
        # print(orig_im)
        images_adv_list[i] = images_adv_list[i].reshape(28, 28)
...
def adversarial_learning(best_cla_model_path, adv_example_path):
    ...
    #     print(k)
    # pre_dict = torch.load(best_cla_model_path)
...
if __name__ == "__main__":
    ...
    # best_cla_model_path = "D:/python_workplace/resnet-AE/checkpoint/AdversarialLearning/ResNet18/mnist/model/model_68.pth"
    ...
    # best_cla_model_path = "H:/python_workplace/resnet-AE/checkpoint/AE_AdvSet/RetrainClassification/ResNet18/mnist/block_3/round_6/model/model_1.pth"
    # best_cla_model_path = "F:/AE_CleanSet/RetrainClassification/ResNet18/mnist/block_4/round_5/model/model_9.pth"
    # best_cla_model_path = "D:/python_workplace/resnet-AE/checkpoint/Joint_Training/ResNet18/mnist/block_1/model/model_2.pth"
    # best_cla_model_path = "D:/python_workplace/resnet-AE/checkpoint/Joint_Training/ResNet18/mnist/block_2/model/model_2.pth"
    # best_cla_model_path = "D:/python_workplace/resnet-AE/checkpoint/Joint_Training/ResNet18/mnist/block_3/model/model_34.pth"
    # best_cla_model_path = "D:/python_workplace/resnet-AE/checkpoint/Joint_Training/ResNet18/mnist/block_4/model/model_44.pth"
    # best_cla_model_path = "D:/python_workplace/resnet-AE/checkpoint/Joint_Training_DCT_0.01(14,7)/ResNet18/mnist/block_1/model/model_3.pth"
    best_cla_model_path = "D:/python_workplace/resnet-AE/checkpoint/AdversarialLearning/ResNet18/mnist/DDN/model/model_45.pth"
    # best_cla_model_path = "D:/python_workplace/resnet-AE/model/DDN_adv/mnist.pth"
