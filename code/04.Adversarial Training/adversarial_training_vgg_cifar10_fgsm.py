...
def adversarial_learning(best_cla_model_path):
    ...
    parser.add_argument('--model_path', type=str,
                        default='D:/python_workplace/resnet-AE/checkpoint/AdversarialLearning/VGG/cifar10/model/',
                        help='Save model path')
    parser.add_argument('--acc_file_path', type=str,
                        default='D:/python_workplace/resnet-AE/checkpoint/AdversarialLearning/VGG/cifar10/acc.txt',
                        help='Save accuracy file')
    parser.add_argument('--best_acc_file_path', type=str,
                        default='D:/python_workplace/resnet-AE/checkpoint/AdversarialLearning/VGG/cifar10/best_acc.txt',
                        help='Save best accuracy file')
    parser.add_argument('--log_file_path', type=str,
                        default='D:/python_workplace/resnet-AE/checkpoint/AdversarialLearning/VGG/cifar10/log.txt',
                        help='Save log file')
...
if __name__ == '__main__':
    best_cla_model_path = 'D:/python_workplace/resnet-AE/checkpoint/Classification/VGG/cifar10/model/model_' + str(
        300) + '.pth'
