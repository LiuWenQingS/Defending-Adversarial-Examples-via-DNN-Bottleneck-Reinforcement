...
def load_test_set_clean(input_dir, batch_shape):
    ...
    for j in range(len(images_clean_list)):
        image_test_clean[idx, :, :, :] = images_clean_list[j]
...
def load_test_set_adv(input_dir, batch_shape):
    ...
    for j in range(len(images_adv_list)):
        image_test_adv[idx, :, :, :] = images_adv_list[j]
...
def adversarial_learning(best_cla_model_path):
    ...
    parser.add_argument('--model_path', type=str,
                        default='D:/python_workplace/resnet-AE/checkpoint/AdversarialLearning/VGG/mnist/model/',
                        help='Save model path')
    parser.add_argument('--acc_file_path', type=str,
                        default='D:/python_workplace/resnet-AE/checkpoint/AdversarialLearning/VGG/mnist/acc.txt',
                        help='Save accuracy file')
    parser.add_argument('--best_acc_file_path', type=str,
                        default='D:/python_workplace/resnet-AE/checkpoint/AdversarialLearning/VGG/mnist/best_acc.txt',
                        help='Save best accuracy file')
    parser.add_argument('--log_file_path', type=str,
                        default='D:/python_workplace/resnet-AE/checkpoint/AdversarialLearning/VGG/mnist/log.txt',
                        help='Save log file')
...
if __name__ == '__main__':
    best_cla_model_path = 'D:/python_workplace/resnet-AE/checkpoint/Classification/VGG/mnist/model/model_' + str(
        150) + '.pth'
