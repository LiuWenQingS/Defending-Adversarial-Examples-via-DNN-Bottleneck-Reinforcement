...
def FGSM(best_cla_model_path, device_used):
    ...
    parser.add_argument("--output_path_train", type=str,
                        default="D:/python_workplace/resnet-AE/outputData/FGSM/cifar10/ResNet50/train/train.pkl",
                        help="Output directory with train images.")
    parser.add_argument("--output_path_test", type=str,
                        default="D:/python_workplace/resnet-AE/outputData/FGSM/cifar10/ResNet50/test/test.pkl",
    ...
    parser.add_argument("--output_path_acc", type=str,
                        default="D:/python_workplace/resnet-AE/outputData/FGSM/cifar10/ResNet50/acc.txt",
    ...
    # Define Network
    model = resnet_cifar.resnet50(pretrained=False)
...
if __name__ == "__main__":
    FGSM("D:/python_workplace/resnet-AE/checkpoint/Classification/ResNet50/cifar10/model/model_140.pth", "cuda:1")
    # FGSM(
    #     "D:/python_workplace/resnet-AE/checkpoint/AdversarialLearning/ResNet18/cifar10/model/model_50.pth",
    #     1, 3, "AE_CleanSet", "cuda:0")
    # FGSM("D:/python_workplace/resnet-AE/checkpoint/Joint_Training/ResNet18/cifar10/block_1/decoder_3/model/model_50.pth", 1, 1,
    #      "AE_CleanSet", "cuda:0")
    # FGSM("D:/python_workplace/resnet-AE/checkpoint/Joint_Training/ResNet18/cifar10/block_1/decoder_2/model/model_50.pth", 1, 1,
    #      "AE_CleanSet", "cuda:0")
    # FGSM(
    #     "D:/python_workplace/resnet-AE/checkpoint/Joint_Training/ResNet18/cifar10/block_1/decoder_4/model/model_250.pth",
    #     1, 1, "AE_AdvSet", "cuda:1")
    # FGSM(
    #     "D:/python_workplace/resnet-AE/checkpoint/Joint_Training/ResNet18/cifar10/block_1/decoder_4_3/model/model_100.pth",
    #     1, 1, "AE_AdvSet", "cuda:0")
    # FGSM(
    #     "D:/python_workplace/resnet-AE/checkpoint/Joint_Training/ResNet18/cifar10/block_1/decoder_4_1/model/model_100.pth",
    #     1, 1, "AE_AdvSet", "cuda:1")
    # FGSM(
    #     "D:/python_workplace/resnet-AE/checkpoint/Joint_Training/ResNet18/cifar10/block_2/model/model_10.pth",
    #     1, 1, "AE_AdvSet", "cuda:1")
    # FGSM(
    #     "D:/python_workplace/resnet-AE/checkpoint/Joint_Training/ResNet18/cifar10/block_1/decoder_4_10/model/model_30.pth",
    #     1, 1, "AE_AdvSet", "cuda:1")