...
class ResNet_AutoEncoder(nn.Module):
    ...
    def __init__(self, block_encoder, block_decoder, layers):
        ...
        self.decoder_layer2 = self._make_decoder_layer_3(block_decoder, 256, layers[2], stride=3)
        self.decoder_layer3 = self._make_decoder_layer_3(block_decoder, 128, layers[1], stride=2)
